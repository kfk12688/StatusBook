         ...
         <div class="sidebar left sidebar-size-2 sidebar-offset-0 sidebar-visible-desktop sidebar-visible-mobile sidebar-skin-dark" id="sidebar-menu" data-type="collapse">
            <div data-scrollable>
                <ul class="sidebar-menu">
                    ...
                    <li class=""><a href="Dashboard.php"><i class="md md-my-library-books"></i> <span>Dashboard</span></a>
                    </li>
                    <li><a href="index.html"><i class="md md-assignment"></i> <span>Portfolio</span></a>
                    </li>
