...
mysql_query("insert into placement_students(id, regno, date, name, dept, company) values(' ','$regno','$date', '$name', '$dept', '$company')")or die(mysql_error);
...
mysql_select_db("csebatch2011", $con);
         $id=$_POST['id'];
        mysql_query("delete from placement_students where id='$id'");
        header("location:completed task.php");
}
?>
                                        ...
                                        <div class="panel-body">
                                            <form class="form-horizontal" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="inputEmail3" placeholder="Student Name" name="name">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="inputEmail3" placeholder="Department" name="dept">
                                                    </div>
                                                </div>
                                                 <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="inputEmail3" placeholder="Placed Company" name="company">
                                                    </div>
                                                </div>
                                                ...
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <button type="submit" class="btn btn-primary" name="submit11">Submit</button>
                                            </form></div>
                                </div>
                            </div>
                            <!-- // END col -->
                                            ...
                                            <li class="padding-v-5">
                                                <?php $result=mysql_query("select * from placement_students")or die(mysql_error);
                                                       while( $row=mysql_fetch_array($result))
                                                       {
                                                        ...
                                                        echo '<div class="row">';
                                                    echo '<div class="col-sm-4">'.'<span class="text-muted">'.'<b>'.$id.'<br>'.'Date'.'<br>'.'Student Name'.'<br>'.'Department'.'<br>'.'Company'.'</b>'.'</span>';
                                                    echo '</div>';
                                                    echo '<div class="col-sm-8">'.$regno.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.'<br>'.$date.'<br>'.$name.'<br>'.$dept.'<br>'.$company.'<br>'.'</div>';
                                                    echo '</div>';
                                                    echo '</li>';
                                                }?>
