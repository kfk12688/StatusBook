            ...
            <div data-scrollable>
                <ul class="sidebar-menu">
                    ...
                    <li class="category">Categories</li>
                     ...
                     <li class=""><a href="activity schedules.php"><i class="md md-my-library-books"></i> <span>Upcoming Drives</span></a>
                    </li>
                    
                      <li class=""><a href="completed task.php"><i class="md md-verified-user"></i> <span>Placed Student</span></a>
                    </li>
