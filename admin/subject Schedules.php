...
$content4=$row1['content4'];
$content5=$row1['content5'];
$content6=$row1['content6'];
...
mysql_query("update subject_schedule set subject_code='$subject_code' where regno='$regno'");
mysql_query("update subject_schedule set subject_name='$subject_name' where regno='$regno'");
mysql_query("update subject_schedule set unit1='$unit1' where regno='$regno'");
mysql_query("update subject_schedule set unit2='$unit2' where regno='$regno'");
mysql_query("update subject_schedule set unit3='$unit3' where regno='$regno'");
mysql_query("update subject_schedule set unit4='$unit4' where regno='$regno'");
mysql_query("update subject_schedule set unit5='$unit5' where regno='$regno'");
mysql_query("update subject_schedule set unit6='$unit6' where regno='$regno'");
mysql_query("update subject_schedule set content1='$content1' where regno='$regno'");
mysql_query("update subject_schedule set content2='$content2' where regno='$regno'");
mysql_query("update subject_schedule set content3='$content3' where regno='$regno'");
mysql_query("update subject_schedule set content4='$content4' where regno='$regno'");
mysql_query("update subject_schedule set content5='$content5' where regno='$regno'");
mysql_query("update subject_schedule set content6='$content6' where regno='$regno'");
mysql_query("update subject_schedule set description='$description' where regno='$regno'");
         ...
         <div class="sidebar left sidebar-size-2 sidebar-offset-0 sidebar-visible-desktop sidebar-visible-mobile sidebar-skin-dark" id="sidebar-menu" data-type="collapse">
            <div data-scrollable>
                <ul class="sidebar-menu">
                    ...
                    <li><a href="#" data-dialog77="somedialog77" ><i class="md md-event-available" ></i> <span>Student Details</span></a>
                    </li>
                                        ...
                                        <div class="panel-body">
                                            <form class="form-horizontal" method="POST" action="">
                                                 <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="inputEmail3" placeholder="Subject Name" name="subject_code" value="<?php echo $subject_code; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">Subject Name</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="inputEmail3" placeholder="Subject Name" name="subject_name" value="<?php echo $subject_name; ?>">
                                                    </div>
                                                </div>
                                                 <div class="form-group">
                                                    <label class="col-sm-3 control-label">Unit I</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="inputEmail3" placeholder="Title.." name="unit1" value="<?php echo $unit1; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">Content</label>
                                                    <div class="col-sm-9">
                                                        <textarea class="form-control" rows="15" name="content1" value="<?php echo $content1; ?>"></textarea>
                                                    </div>
                                                </div>
                                            <div class="form-group">
                                                    <label for="inputEmail3" class="col-sm-3 control-label">Unit II</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="inputEmail3" placeholder="Title.." name="unit2" value="<?php echo $unit2; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">Content</label>
                                                    <div class="col-sm-9">
                                                        <textarea class="form-control" rows="15" name="content2" value="<?php echo $content2; ?>"></textarea>
                                                    </div>
                                                </div>
                                            <div class="form-group">
                                                    <label for="inputEmail3" class="col-sm-3 control-label">Unit III</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="inputEmail3" placeholder="Title.." name="unit3" value="<?php echo $unit3; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">Content</label>
                                                    <div class="col-sm-9">
                                                        <textarea class="form-control" rows="15" name="content3" value="<?php echo $content3; ?>"></textarea>
                                                    </div>
                                                </div>
                                            <div class="form-group">
                                                    <label for="inputEmail3" class="col-sm-3 control-label" >Unit IV</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="inputEmail3" placeholder="Title.." name="unit4" value="<?php echo $unit4; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">Content</label>
                                                    <div class="col-sm-9">
                                                        <textarea class="form-control" rows="15" name="content4" value="<?php echo $content4; ?>"></textarea>
                                                    </div>
                                                </div>
                                            <div class="form-group">
                                                    <label for="inputEmail3" class="col-sm-3 control-label">Unit V</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="inputEmail3" placeholder="Title.." name="unit5" value="<?php echo $unit5; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">Content</label>
                                                    <div class="col-sm-9">
                                                        <textarea class="form-control" rows="15" name="content5" value="<?php echo $content5; ?>"></textarea>
                                                    </div>
                                                </div>
                                            <div class="form-group">
                                                    <label for="inputEmail3" class="col-sm-3 control-label">Unit VI</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="inputEmail3" placeholder="Title.." name="unit6" value="<?php echo $unit6; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">Content</label>
                                                    <div class="col-sm-9">
                                                        <textarea class="form-control" rows="15" name="content6" value="<?php echo $content6; ?>"></textarea>
                                                    </div>
                                                </div>
                                                 <div class="form-group">
                                                    <label class="col-sm-3 control-label">Description</label>
                                                    <div class="col-sm-9">
                                                        <textarea class="form-control" rows="15" name="description" value="<?php echo $description; ?>"></textarea>
                                                    </div>
                                                </div>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
