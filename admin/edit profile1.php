...
mysql_query("update admin set fname='$fname' where regno='$regno'");
mysql_query("update admin set lname='$lname' where regno='$regno'");
mysql_query("update admin set email='$email' where regno='$regno'");
mysql_query("update admin set dob='$dob' where regno='$regno'");
mysql_query("update admin set amobile='$amobile' where regno='$regno'");
mysql_query("update admin set mobile='$mobile' where regno='$regno'");
mysql_query("update admin set gender='$gender' where regno='$regno'");
mysql_query("update admin set taddress='$taddress' where regno='$regno'");
mysql_query("update admin set paddress='$paddress' where regno='$regno'");
mysql_query("update admin set aoi='$aoi' where regno='$regno'");
mysql_query("update admin set nationality='$nationality' where regno='$regno'");
mysql_query("update admin set relegion='$relegion' where regno='$regno'");
mysql_query("update admin set hobbies='$hobbies' where regno='$regno'");
