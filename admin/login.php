...
$result=mysql_query("select * from admin where regno='$regno' and npassword='$npassword'")or die (mysql_error());
...
$row=mysql_fetch_array($result);
        ...
        mysql_query("update admin set lilostatus='Online' where regno='$regno'");
        }
                            else{
