...
$result=mysql_query("select * from sports where regno='$regno' and npassword='$npassword'")or die (mysql_error());
...
$row=mysql_fetch_array($result);
        ...
        mysql_query("update sports set lilostatus='Online' where regno='$regno'");
        }
                            else{
