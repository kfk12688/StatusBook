...
mysql_query("insert into sports_schedules(id, regno, date, topic, content) values(' ','$regno','$date', '$topic', '$content')")or die(mysql_error);
            ...
            <div data-scrollable>
                <ul class="sidebar-menu">
                    ...
                    <li class="category">Categories</li>
                     ...
                     <li class=""><a href="activity schedules.php"><i class="md md-my-library-books"></i> <span>Upcomings</span></a>
                    </li>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <form class="form-horizontal" method="POST">
                                                ...
                                                <div class="form-group">
                                                    <label for="inputEmail3" class="col-sm-3 control-label">Topic</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="inputEmail3" placeholder="Title" name="topic">
                                                    </div>
                                                </div> 
                                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading panel-heading-gray">
                                        ...
                                        <i class="fa fa-fw fa-info-circle"></i> Registered Contents
                                    </div>
                                    <div class="panel-body">
                                        <ul class="list-unstyled profile-about margin-none">
                                            <li class="padding-v-5">
                                                <?php $result=mysql_query("select * from sports_schedules")or die(mysql_error);
                                                       while( $row=mysql_fetch_array($result))
                                                       {
                                                        ...
                                                        echo '<div class="row">';
                                                    echo '<div class="col-sm-4">'.'<span class="text-muted">'.$id.'</span>';
                                                    echo '</div>';
                                                    echo '<div class="col-sm-8">'.$regno.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$date.'<br>'.$topic.'<br>'.$content.'</div>';
                                                    echo '</div>';
                                                    echo '</li>';
                                                }?>              
                                            </li>
