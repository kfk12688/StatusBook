        ...
        <script type="text/javascript" language="javascript" >
			$(document).ready(function() {
			   var dataTable =  $('#employee-grid').DataTable( {
			   	...
			   	processing: true,
			   	serverSide: true,
		   		ajax: "employee-grid-data - Copy5.php", // json datasource
			    } );
			} );
		</script>
		<style>
    ...
    <div class="navbar navbar-main navbar-primary navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                <div class="navbar-header">
                   ...
                   <a class="navbar-brand" href="../timeline.php">Status Book</a><a class="navbar-brand" href="../dashboard.php">Subject Code : <?php echo $subject ?></a>
                </div>
           ...
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</style><a href="../tables/index5.php" class="btn btn-primary">Click Here To Edit</a>
