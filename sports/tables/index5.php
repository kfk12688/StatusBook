...
<html class="st-layout ls-top-navbar ls-bottom-footer show-sidebar sidebar-l2" lang="en">
 ...
 <head>
  ...
  <script>
	 ...
	 var columns = new Array("regno","name","model_exam","university_exam","month","year");
	 var placeholder = new Array("Regno","Name","Model Exam","University Exam","Month","year");
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="main-nav">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <!-- User -->
                        <li class="dropdown">
                            <a href="../datatable/index5.php" class="dropdown-toggle user" data-toggle="dropdown">
                                 Back To View 
                            </a>
