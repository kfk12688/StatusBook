...
mysql_query("insert into sports_activites(id, regno, date, topic, content) values(' ','$regno','$date', '$topic', '$content')")or die(mysql_error);
         ...
         <div class="sidebar left sidebar-size-2 sidebar-offset-0 sidebar-visible-desktop sidebar-visible-mobile sidebar-skin-dark" id="sidebar-menu" data-type="collapse">
            <div data-scrollable>
                <ul class="sidebar-menu">
                    ...
                    <li class=""><a href="subject schedules.php"><i class="md md-my-library-books"></i> <span>Upcomings</span></a>
                    </li>
                                    ...
                                    <div class="panel-body">
                                        <ul class="list-unstyled profile-about margin-none">
                                            <li class="padding-v-5">
                                                <?php $result=mysql_query("select * from sports_activites")or die(mysql_error);
