...
if($npassword == $cpassword)
    {
mysql_query("update sports set fname='$fname', npassword='$npassword', cpassword='$cpassword' where regno='$regno'");
}
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group form-control-default">
                                                            <label for="fname">sports name</label>
                                                        ...
                                                        <div class="form-group form-control-default">
                                                            <label for="fname">cpassword</label>
