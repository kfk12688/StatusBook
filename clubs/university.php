        ...
        <div class="sidebar left sidebar-size-2 sidebar-offset-0 sidebar-visible-desktop sidebar-visible-mobile sidebar-skin-dark" id="sidebar-menu">
            <div data-scrollable>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="active"><a href="university.php"><i class="md md-assignment"></i> <span>University Exams</span></a>
                    </li>
                </ul>
            ...
            <div class="st-content">
                ...
                <div class="st-content-inner">
                    ...
                    <div class="container-fluid">
                        ...
                        <h4 class="page-section-heading">Model Exam And University Exam Mark Details</h4>
                                    <div class="panel panel-default">
                                        ...
                                        <table data-toggle="data-table" class="table" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                $model_exam=$row11['model_exam'];
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];
                                                $subject_code='cs2023';
                                                ?>
                                                    ...
                                                    <td><?php echo $model_exam;?></td>
                                                    <td><?php echo $university_exam;?></td>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='cs2028';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='cs2029';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='cs2041';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='cs2201';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='cs2202';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='cs2203';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='cs2204';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='cs2251';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='cs2252';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='cs2253';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='cs2254';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year']; $subject_code='cs2255';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='cs2301';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='cs2302';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year']; $subject_code='cs2303';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year']; $subject_code='cs2304';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='cs2305';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='cs2351';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='cs2352';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='cs2353';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='cs2354';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='cs2401';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year']; $subject_code='cs2402';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='cs2403';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='cy2111';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='cy2161';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='ec2151';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='ge2021';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='ge2111';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='ge2112';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='hs2111';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='hs2161';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='it2353';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year']; $subject_code='ma2111';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='ma2161';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='ma2211';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='ma2262';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='ma2265';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='mg2452';
                                                ?>
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='ph2111';
                                                ?>
                                               ...
                                               <?php 
                                                ...
                                                $university_exam=$row11['university_exam'];
                                                $month=$row11['month'];
                                                $year=$row11['year'];$subject_code='ph2161';
                                                ?>
