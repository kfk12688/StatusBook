...
mysql_query("insert into club_schedules(id, regno, date, topic, content) values(' ','$regno','$date', '$topic', '$content')")or die(mysql_error);
...
mysql_select_db("csebatch2011", $con);
         $id=$_POST['id'];
        mysql_query("delete from club_schedules where id='$id'");
                                            ...
                                            <li class="padding-v-5">
                                                <?php $result=mysql_query("select * from club_schedules")or die(mysql_error);
                                                       while( $row=mysql_fetch_array($result))
                                                       {
                                                        ...
                                                        echo '<div class="row">';
                                                    echo '<div class="col-sm-4">'.'<span class="text-muted"><b>'.$id.'<br>'.'Date'.'<br>'.'Topic'.'<br>'.'Contents'.'</b></span>';
                                                    echo '</div>';
