        ...
        <div class="sidebar left sidebar-size-2 sidebar-offset-0 sidebar-visible-desktop sidebar-visible-mobile sidebar-skin-dark" id="sidebar-menu">
            <div data-scrollable>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li><a href="dashboard.php"><i class="fa fa-group"></i> <span>DashBoard</span></a>
                    </li>
        ...
        <div class="st-pusher" id="content">
            ...
            <div class="st-content">
                ...
                <div class="st-content-inner">
                    ...
                    <iframe src="chat/index.php" frameborder="0" marginheight="100%" marginwidth="100%" height="100%" width="100%"></iframe>
                    <div class="container-fluid">
