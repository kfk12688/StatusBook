...
mysql_query("insert into club_activites(id, regno, date, topic, content) values(' ','$regno','$date', '$topic', '$content')")or die(mysql_error);
...
mysql_select_db("csebatch2011", $con);
         $id=$_POST['id'];
        mysql_query("delete from club_activites where id='$id'");
        header("location:activity schedules.php");
}
?>
