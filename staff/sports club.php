                            ...
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading panel-heading-gray">
                                        ...
                                        <i class="fa fa-fw fa-info-circle"></i>Sports Activity Schedules
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading panel-heading-gray">
                                        ...
                                        <i class="icon-user-1"></i> Completed Activites From Sports Club
                                    </div>
                                    <div class="panel-body">
                                        <ul class="list-unstyled profile-about margin-none">
                                                       ...
                                                       while( $row=mysql_fetch_array($result))
                                                       {
                                                        ...
                                                        echo '<li class="padding-v-5">';
                                                        echo '<div class="row">';
                                                    echo '<div class="col-sm-4">'.'<span class="text-muted"><b>'.$id.'<br>'.'Date'.'<br>'.'Title'.'<br>'.'Contents'.'</b></span>';                                                    echo '</div>';
                                                    echo '<div class="col-sm-8">'.$regno.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<br>;'.$date.'<br>'.$topic.'<br>'.$content.'</div>';
                                                    echo '</div>';
                                                    echo '</li>';
                                                }?>
