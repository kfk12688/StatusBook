...
$sql = "SELECT subject";
$sql.=" FROM staff where regno='$regno'";
...
if( !empty($requestData['search']['value']) ) {
	...
	$sql.=" OR class_test1 LIKE '".$requestData['search']['value']."%' ";
	$sql.=" OR class_test2 LIKE '".$requestData['search']['value']."%' ";
	$sql.=" OR class_test3 LIKE '".$requestData['search']['value']."%' ";
	$sql.=" OR iae1 LIKE '".$requestData['search']['value']."%' ";
	$sql.=" OR iae2 LIKE '".$requestData['search']['value']."%' ";
	$sql.=" OR iae3 LIKE '".$requestData['search']['value']."%' ";
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$nestedData[] = $row["name"];
	$nestedData[] = $row["class_test1"];
	$nestedData[] = $row["class_test2"];
	$nestedData[] = $row["class_test3"];
	$nestedData[] = $row["iae1"];
	$nestedData[] = $row["iae2"];
	$nestedData[] = $row["iae3"];
