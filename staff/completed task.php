...
mysql_query("update completed_tasks set regno='$regno'")or die(mysql_error());
mysql_query("update completed_tasks set date='$date' ")or die(mysql_error());
mysql_query("update completed_tasks set subject_code1='$subject_code1' ")or die(mysql_error());
mysql_query("update completed_tasks set subject_code2='$subject_code2' ")or die(mysql_error());
mysql_query("update completed_tasks set subject_code3='$subject_code3' ")or die(mysql_error());
mysql_query("update completed_tasks set subject_code4='$subject_code4' ")or die(mysql_error());
mysql_query("update completed_tasks set topics1='$topics1' ")or die(mysql_error());
mysql_query("update completed_tasks set topics2='$topics2' ")or die(mysql_error());
mysql_query("update completed_tasks set topics3='$topics3' ")or die(mysql_error());
mysql_query("update completed_tasks set topics4='$topics4' ")or die(mysql_error());
       ...
       <div class="st-container">
        ...
        <div class="st-pusher" id="content">
            ...
            <div class="panel-body">
                                            <form class="form-horizontal" role="form"  action="completed task1.php" method="post">
                                            <div class="form-group">
                                            <label class="col-sm-3 control-label">Enter the Date to view Details</label>
                                            <div class="col-sm-4">
                                            <div class="input-group">
