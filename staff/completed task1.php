...
$pic=$regno.".jpg";
$date=$_POST['date'];
$result1=mysql_query("select * from completed_tasks where date='$date'")or die(mysql_error());
$row1=mysql_fetch_array($result1);
$subject_code1=$row1['subject_code1'];
$subject_code2=$row1['subject_code2'];
$subject_code3=$row1['subject_code3'];
$subject_code4=$row1['subject_code4'];
$topics1=$row1['topics1'];
$topics2=$row1['topics2'];
$topics3=$row1['topics3'];
$topics4=$row1['topics4'];
$date=$row1['date'];
