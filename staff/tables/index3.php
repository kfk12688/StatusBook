...
<?php
	...
	require_once("ajax_table.class3.php");
	$obj = new ajax_table();
...
<html class="st-layout ls-top-navbar ls-bottom-footer show-sidebar sidebar-l2" lang="en">
 ...
 <head>
  ...
  <script>
	 ...
	 var columns = new Array("regno","name","class_test1","class_test2","class_test3");
	 var placeholder = new Array("Regno","Name","Class Test 1","Class Test 2","Class Test 3");
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="main-nav">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <!-- User -->
                        <li class="dropdown">
                            <a href="../datatable/index3.php" class="dropdown-toggle user" data-toggle="dropdown">
                                 Back To View 
                            </a>
