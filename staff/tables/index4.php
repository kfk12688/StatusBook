...
<html class="st-layout ls-top-navbar ls-bottom-footer show-sidebar sidebar-l2" lang="en">
 ...
 <head>
  ...
  <script>
	 ...
	 var columns = new Array("regno","name","iae1","iae2","iae3");
	 var placeholder = new Array("Regno","Name","IAE 1","IAE 2", "IAE 3");
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="main-nav">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <!-- User -->
                        <li class="dropdown">
                            <a href="../datatable/index4.php" class="dropdown-toggle user" data-toggle="dropdown">
                                 Back To View 
                            </a>
