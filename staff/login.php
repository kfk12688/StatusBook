...
$result=mysql_query("select * from staff where regno='$regno' and npassword='$npassword'")or die (mysql_error());
...
$row=mysql_fetch_array($result);
    if ($count > 0){
        ...
        mysql_query("update staff set lilostatus='Online' where regno='$regno'");
        }
                            else{
