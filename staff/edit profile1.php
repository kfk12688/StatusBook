...
if($npassword == $cpassword)
    {
mysql_query("update staff set  npassword='$npassword', cpassword='$cpassword' where regno='$regno'");
}
else echo ' invalid Password';      
mysql_query("update staff set fname='$fname' where regno='$regno'");
mysql_query("update staff set lname='$lname' where regno='$regno'");
mysql_query("update staff set email='$email' where regno='$regno'");
mysql_query("update staff set dob='$dob' where regno='$regno'");
mysql_query("update staff set amobile='$amobile' where regno='$regno'");
mysql_query("update staff set mobile='$mobile' where regno='$regno'");
mysql_query("update staff set gender='$gender' where regno='$regno'");
mysql_query("update staff set npassword='$npassword' where regno='$regno'");
mysql_query("update staff set taddress='$taddress' where regno='$regno'");
mysql_query("update staff set paddress='$paddress' where regno='$regno'");
mysql_query("update staff set aoi='$aoi' where regno='$regno'");
mysql_query("update staff set nationality='$nationality' where regno='$regno'");
mysql_query("update staff set relegion='$relegion' where regno='$regno'");
mysql_query("update staff set hobbies='$hobbies' where regno='$regno'");
            ...
            <div data-scrollable>
                ...
                <ul class="sidebar-menu">
                    <li class="active"><a href="edit profile.php"><i class="icon-user-1"></i> <span>Edit Profile</span></a>
                     ...
                     <li><a href="dashboard.php"><i class="md md-assignment"></i> <span>Dashboard</span></a>
                    </li>
                </ul>
