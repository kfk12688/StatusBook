...
?>
                ...
                <div class="collapse navbar-collapse" id="subnav">
                                <ul class="nav navbar-nav">
                                    <li><a href="timeline.php"><i class="fa fa-fw icon-ship-wheel"></i> My Timeline</a>
                                     ...
                                     <li><a href="cropimages/index.php"><i class="fa fa-fw icon-ship-wheel"></i>Upload Your Image</a>
                                    </li>
                                </ul>
                                <ul class="nav navbar-nav navbar-right">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading panel-heading-gray">
                                        <a href="edit profile1.php" class="btn btn-white btn-xs pull-right"><i class="fa fa-pencil"></i></a>
                                        ...
                                        <ul class="list-unstyled profile-about margin-none">
                                            ...
                                            <li class="padding-v-5">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8"><?php echo $paddress; ?></div>
                                                </div>
                                            </li>
                                            <li class="padding-v-5">
                                                <div class="row">
                                                    <div class="col-sm-4"><span class="text-muted">Mobile Number</span>
                                                    </div>
                                                    <div class="col-sm-8"><?php echo $mobile; ?></div>
                                                </div>
                                            </li>
                                            <li class="padding-v-5">
                                                <div class="row">
                                                    <div class="col-sm-4"><span class="text-muted">Nationality</span>
                                                    </div>
                                                    <div class="col-sm-8"><?php echo $nationality; ?></div>
                                                </div>
                                            </li>
                                            <li class="padding-v-5">
                                                <div class="row">
                                                    <div class="col-sm-4"><span class="text-muted">Relegion</span>
                                                    </div>
                                                    <div class="col-sm-8"><?php echo $relegion; ?></div>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <ul class="list-unstyled profile-about margin-none">
                                                                                 <?php $result=mysql_query("select * from staff")or die(mysql_error);
                                                    ...
                                                    echo '</div>';
                                                    echo '<div class="col-sm-8">'.$fname.'</div>';
                                                    echo '</div>';
                                                    echo '</li>';
                                                }?></ul>
                                    </div>
    ...
    <script src="sathish/js/vendor-forms.js"></script>
        <script src="sathish/js/vendor-map.js"></script>
