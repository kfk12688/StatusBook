        ...
        <div class="container-fluid">
            <div class="lock-container">
                ...
                <div class="panel panel-default text-center">
                    ...
                    $result=mysql_query("select * from student where regno='$regno' and npassword='$npassword'")or die (mysql_error());   
                    ...
                    $row=mysql_fetch_array($result);
                           if ($count > 0){
                            ...
                            mysql_query("update student set lilostatus='Online' where regno='$regno'");
                            }
                                                else{
